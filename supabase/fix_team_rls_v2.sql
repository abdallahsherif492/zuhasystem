-- Fix Infinite Recursion and Case Sensitivity in Business Users RLS
...
-- 2. Create security definer function to securely check if user is an admin of the business
...
-- 3. Drop all the restrictive policies
...
-- 4. Recreate policies using the safe functions
