        ...
        Papa.parse(selectedFile, {
            ...
            complete: async (results) => {
                ...
                try {
                    ...
                    // Newer Meta exports name it "Amount spent (EGP)".
                    const spentCol = Object.keys(parsedData[0] || {}).find(k => k.startsWith("Amount spent")) || "Amount spent";

                    const recordsToInsert = parsedData
                        .filter(row => row["Day"] && row[spentCol])
                        .map(row => {
                            let isoDate;
                            ...
                            return {
                                ...
                                ad_date: isoDate,
                                amount: parseFloat(row[spentCol]) * 1.14, // Add 14% VAT
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-semibold">Daily Ad Spend</h2>
                    <p className="text-muted-foreground">Total ad spend per day, for the Insights page. Reports uploaded under Ads performance add their totals here by themselves.</p>
                </div>
