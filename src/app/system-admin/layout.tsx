...
import { LayoutDashboard, Store, Ticket, ShieldCheck, LogOut, Menu, Users, Banknote, Tag, Settings, MessageSquare, Activity, UserPlus } from "lucide-react";
        ...
        <div className="space-y-4 py-4">
            <div className="px-3 py-2">
                ...
                <div className="space-y-1">
                    ...
                    <Link href="/system-admin/live">
                        <Button
                            variant={pathname.startsWith("/system-admin/live") ? "secondary" : "ghost"}
                            className="w-full justify-start"
                        >
                    ...
                    <Link href="/system-admin/pricing">
                        <Button
                            variant={pathname.startsWith("/system-admin/pricing") ? "secondary" : "ghost"}
                            className="w-full justify-start"
                        >
                    ...
                    <Link href="/system-admin/signups">
                        <Button
                            variant={pathname.startsWith("/system-admin/signups") ? "secondary" : "ghost"}
                            className="w-full justify-start"
                        >
                    ...
                    <Link href="/system-admin/users">
                        <Button
                            variant={pathname.startsWith("/system-admin/users") ? "secondary" : "ghost"}
                            className="w-full justify-start"
                        >
